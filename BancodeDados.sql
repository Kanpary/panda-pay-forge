...
CREATE TABLE IF NOT EXISTS `affiliate_commissions` (
  ...
  KEY `idx_level` (`level`),
  UNIQUE KEY `idx_deposit_level` (`deposit_id`, `level`)
...
(99, 'level_real', 1.00, 'Nível de dificuldade inicial na conta real'),
(100, 'level_demo', 1.00, 'Nível de dificuldade inicial na conta demo'),
(101, 'coin_value_real', 0.01, 'Valor da moeda na conta real'),
(102, 'coin_value_demo', 0.01, 'Valor da moeda na conta demo'),
(103, 'difficulty_increment_real', 2.00, 'Incremento de dificuldade na conta real'),
(104, 'difficulty_increment_demo', 2.00, 'Incremento de dificuldade na conta demo'),
(105, 'flower_value_real_1', 1.00, 'Valor 1 da flor na conta real'),
(106, 'flower_value_real_2', 1.00, 'Valor 2 da flor na conta real'),
(107, 'flower_value_real_3', 1.00, 'Valor 3 da flor na conta real'),
(108, 'flower_value_real_4', 1.00, 'Valor 4 da flor na conta real'),
(109, 'flower_value_demo_1', 50.00, 'Valor 1 da flor na conta demo'),
(110, 'flower_value_demo_2', 50.00, 'Valor 2 da flor na conta demo'),
(111, 'flower_value_demo_3', 50.00, 'Valor 3 da flor na conta demo'),
(112, 'flower_value_demo_4', 50.00, 'Valor 4 da flor na conta demo'),
(113, 'branch_value_real_1', 0.00, 'Valor 1 do ramo na conta real'),
(114, 'branch_value_real_2', 0.00, 'Valor 2 do ramo na conta real'),
(115, 'branch_value_real_3', 0.00, 'Valor 3 do ramo na conta real'),
(116, 'branch_value_real_4', 0.00, 'Valor 4 do ramo na conta real'),
(117, 'branch_value_demo_1', 0.00, 'Valor 1 do ramo na conta demo'),
(118, 'branch_value_demo_2', 0.00, 'Valor 2 do ramo na conta demo'),
(119, 'branch_value_demo_3', 0.00, 'Valor 3 do ramo na conta demo'),
(120, 'branch_value_demo_4', 0.00, 'Valor 4 do ramo na conta demo');
